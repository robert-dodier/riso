...
public class ConditionalGaussian extends AbstractConditionalDistribution
{
	...
	/** Default constructor; exists just to throw <tt>RemoteException</tt>.
	  */
	public ConditionalGaussian() throws RemoteException {}
	...
	/** Return the number of dimensions of the child variable.
	  */
	public int ndimensions_child() throws RemoteException { return b_mu_1c2.length; }
	...
	/** Return the number of dimensions of the parent variables.
	  ...
	  */
	public int ndimensions_parent() throws RemoteException { return Sigma_22.length; }
