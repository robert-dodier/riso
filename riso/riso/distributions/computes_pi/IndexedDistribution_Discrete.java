...
System.err.println( "IndxD_Discrete.compute_pi: before pruning, pi msg:\n"+pye.format_string("  ") );
...
if ( too_light.size() > 0 ) System.err.println( "IndxD_Discrete.compute_pi: remove "+too_light.size()+" components." );
