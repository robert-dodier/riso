...
public class RemoteApp
{
	public static void main( String[] args )
	{
		...
		try
		{
			System.setSecurityManager( new RemoteAppSecurityManager() );
			Class c;
...
class RemoteAppSecurityManager extends RMISecurityManager
{
    public void checkAccess(Thread g) {}		// loaded classes are allowed to use threads
    public void checkAccess(ThreadGroup g) {}
    public void checkExit(int status) {} 		// loaded classes can exit the VM

    // ALLOW ??? public void checkLink(String lib) { }

    public void checkPropertiesAccess() {}			// loaded classes can access properties
