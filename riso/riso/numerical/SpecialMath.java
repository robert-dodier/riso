...
//                                    decimal places required  18.30
        ...
        */
        public static double besselFirstZero(double x) {
                ...
                if(y>4.0) {
                        double z=32/(y*y)-1;
                        double amplitude=(0.75+chebyshev(z,bm0cs))/Math.sqrt(y);
                        double theta=y-Math.PI/4+chebyshev(z,bth0cs)/y;
        ...
        */
        public static double mBesselFirstZero(double x) {
                double y=Math.abs(x);
                if(y>3.0)
                        return Math.exp(y)*expMBesselFirstZero(x);
                else
        ...
        */
        private static double expMBesselFirstZero(double x) {
                double y=Math.abs(x);
                if(y>3.0) {
                        if(y>8.0)
        ...
        */
        public static double besselFirstOne(double x) {
                ...
                if(y>4.0) {
                        ...
                        double amplitude=(0.75+chebyshev(z,bm1cs))/Math.sqrt(y);
                        double theta=y-3.0*Math.PI/4+chebyshev(z,bth1cs)/y;
        ...
        */
        public static double mBesselFirstOne(double x) {
                double y=Math.abs(x);
                if(y>3.0)
                        return Math.exp(y)*expMBesselFirstOne(x);
                else if(y==0.0)
                        return 0.0;
                else
        ...
        */
        private static double expMBesselFirstOne(double x) {
                double y=Math.abs(x);
                if(y>3.0) {
                        if(y>8.0)
        ...
        */
        public static double besselSecondZero(double x) {
                if(x>4.0) {
                        ...
                        double amplitude=(0.75+chebyshev(z,bm0cs))/Math.sqrt(x);
                        double theta=x-Math.PI/4+chebyshev(z,bth0cs)/x;
        ...
        */
        public static double besselSecondOne(double x) {
                if(x>4.0) {
                        double z=32.0/(x*x)-1.0;
                        double amplitude=(0.75+chebyshev(z,bm1cs))/Math.sqrt(x);
                        double theta=x-3.0*Math.PI/4+chebyshev(z,bth1cs)/x;
                        return amplitude*Math.sin(theta);
                } else
                        return 2.0*Math.log(0.5*x)*besselFirstOne(x)/Math.PI+(0.5+chebyshev(0.125*x*x-1.0,by1cs))/x;
        }

        private final static double SQRTPI=0.9189385332046727417803297;
...
// Gamma function related constants
                double g_p[] = { -1.71618513886549492533811,
                ...
                double g_q[] = { -30.8402300119738975254353,
                ...
                double g_c[] = { -.001910444077728,8.4171387781295e-4,
...
// Log Gamma related constants
                ...
                double lg_p1[] = { 4.945235359296727046734888,
                ...
                double lg_q1[] = { 67.48212550303777196073036,
                ...
                double lg_q2[] = { 183.0328399370592604055942,
                ...
                double lg_c[] = { -0.001910444077728,8.4171387781295e-4,
                        -5.952379913043012e-4,7.93650793500350248e-4,
...
// Function cache for logBeta
        ...
        * @author Jaco van Kooten
        */
	public static double iBeta(double x, double p, double q) {
                if (x <= 0.0) 
        		return 0.0;
                else if (x >= 1.0)
                        return 1.0;
