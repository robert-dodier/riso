...
/** An instance of this class represents the distribution of the minimum
  ...
  */
public class DistributionMin extends AbstractDistribution
{
	/** The list of distributions represented by this distribution.
	  */
	Distribution[] p;

	/** Constructs a <tt>DistributionMin</tt> given the specified list
	...
	{
		DistributionMin copy = (DistributionMin) super.clone();
	...
	{
		throw new Exception( "DistributionMin.log_prior: not implemented." );
	}
	...
	{
		throw new Exception( "DistributionMin.random: not implemented." );
	}
	...
	{
		throw new Exception( "DistributionMin.update: not implemented." );
	}
	...
	{
		throw new Exception( "DistributionMin.expected_value: not implemented." );
	}
	...
	{
		throw new Exception( "DistributionMin.sqrt_variance: not implemented." );
	}
...
System.err.println( "DistributionMin.effective_support: initial: "+x0+", "+x1 );
...
System.err.println( "\t"+"final: "+this.cdf(x0)+" below "+x0+", "+(1-this.cdf(x1))+" above "+x1 );
	...
	public void pretty_input( SmarterTokenizer st ) throws IOException
	{
		...
		try
		{
			st.nextToken();
			if ( st.ttype != '{' )
				throw new IOException( "DistributionMin.pretty_input: input doesn't have opening bracket." );
		...
		{
			throw new IOException( "DistributionMin.pretty_input: attempt to read object failed:\n"+e );
		}

		if ( ! found_closing_bracket )
			throw new IOException( "DistributionMin.pretty_input: no closing bracket on input." );
	}
}
