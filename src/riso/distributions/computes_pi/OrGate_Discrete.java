...
public class OrGate_Discrete implements PiHelper
{
	...
	/** Returns a description of the sequences of distributions accepted
	  * by this helper -- namely one <tt>OrGate</tt>
	  * followed by any number of <tt>Discrete</tt>.
	  */
	static
	{
		SeqTriple[] s = new SeqTriple[2];
		s[0] = new SeqTriple( "riso.distributions.OrGate", 1 );
	...
	{
		OrGate py = (OrGate) py_in;

		// The zero'th element of each incoming pi-message is interpreted
		// as a "special" state. All the others are lumped together.
		// The output of the or-gate should be understood as the probability
		// that at least one of the inputs is non-zero.
